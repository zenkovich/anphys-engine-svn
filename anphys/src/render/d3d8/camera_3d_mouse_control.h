#ifndef CAMERA_3D_MOUSE_CONTOL_H
#define CAMERA_3D_MOUSE_CONTOL_H

#include "camera.h"

struct grCameraD3DMouseControl:public grCameraD3D
{	
	float mAngleX, 
		  mAngleY;
	vec3  mPosition, 
	...
	grCameraD3DMouseControl();
	grCameraD3DMouseControl(vec2 screenSize, grRenderBase* render);	
	grCameraD3DMouseControl(vec2 screenSize, grRenderBase* render, float sence, float shiftSence, float speedFriction, float axisSence, float maxSpeed);	
	grCameraD3DMouseControl(vec2 screenSize, grRenderBase* render, float sence, float shiftSence, float speedFriction, float axisSence, float maxSpeed,
...
#endif //CAMERA_3D_MOUSE_CONTOL_H