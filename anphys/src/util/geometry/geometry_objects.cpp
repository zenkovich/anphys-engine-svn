...
void arrowGeometry(vertexTexNorm* verticies, int &vertCount, int* indexes, int &polyCount, vec3 size)
{
	...
	indexes[polyCount++] = 0; indexes[polyCount++] = 2; indexes[polyCount++] = 1;
	indexes[polyCount++] = 0; indexes[polyCount++] = 3; indexes[polyCount++] = 2;
	...
	indexes[polyCount++] = 4; indexes[polyCount++] = 5; indexes[polyCount++] = 6;
	indexes[polyCount++] = 4; indexes[polyCount++] = 6; indexes[polyCount++] = 7;
	...
	indexes[polyCount++] = 10; indexes[polyCount++] = 9; indexes[polyCount++] = 8;
	indexes[polyCount++] = 10; indexes[polyCount++] = 8; indexes[polyCount++] = 11;	
	...
	indexes[polyCount++] = 12; indexes[polyCount++] = 13; indexes[polyCount++] = 14;
	indexes[polyCount++] = 12; indexes[polyCount++] = 14; indexes[polyCount++] = 15;
	...
	indexes[polyCount++] = 18; indexes[polyCount++] = 17; indexes[polyCount++] = 19;
	indexes[polyCount++] = 19; indexes[polyCount++] = 17; indexes[polyCount++] = 16;
	...
	indexes[polyCount++] = 20; indexes[polyCount++] = 21; indexes[polyCount++] = 24;
	indexes[polyCount++] = 21; indexes[polyCount++] = 22; indexes[polyCount++] = 24;
	indexes[polyCount++] = 22; indexes[polyCount++] = 23; indexes[polyCount++] = 24;
	indexes[polyCount++] = 23; indexes[polyCount++] = 20; indexes[polyCount++] = 24;
